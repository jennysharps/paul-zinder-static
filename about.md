...
His writing on genre and cult television also appears in <cite>Women in the Western</cite>, <cite><cite>Justified</cite> and Philosophy</cite>, <cite>Contemporary Westerns: Film and Television since 1990</cite>, <cite>The Last Western: <cite>Deadwood</cite> and the End of American Empire</cite>, <cite>Investigating <cite>Veronica Mars</cite>: Essays on the Teen Detective</cite> Series, and <cite>Investigating <cite>Alias</cite>: Secrets and Spies</cite>.
